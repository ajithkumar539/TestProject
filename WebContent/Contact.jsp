...
<body>
	<%@ include file="Header.jsp" %>
	 <div class="container" style="margin-top:65px;">
            ...
            <div class="row">
				<div style="margin-left: 0px;" class="text-center"> <h1>Get in touch with us <a href="#">MyShop.in</a></h1></div>
                <div class="col-lg-8">
      ...
      <form>
        ...
        <p> <a href="mailto:#">info@yourdomain.com</a></p>
        <ul>
        	<li><a href="#" class="skype"><i class="fa fa-skype"></i>&nbsp;skypeuser</a></li>
        	<li><a href="#" class="google"><i class="fa fa-google-plus"></i>&nbsp;googleplus</a></li>
        	<li><a href="#" class="linkedin"><i class="fa fa-linkedin"></i>&nbsp;linkedin_id</a></li>
        	<li><a href="#" class="twitter"><i class="fa fa-twitter"></i>&nbsp;twitter_id</a></li>
        </ul>
     </form>
